          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{request()->is(['siswa','jurusan'])?'show':''}}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{request()->is(['siswa','jurusan'])?'true':''}}" >
                ...
                <div class="dropdown-menu {{request()->is(['siswa','jurusan'])?'show':''}}">
                ...
                <div class="dropdown-menu {{request()->is(['konfigurasi','konfigurasi/*'])?'show':''}}">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      ...
                      <a class="dropdown-item {{request()->is(['konfigurasi/jambelajar'])?'active':''}}" href="/konfigurasi/jambelajar">
                        Jam Belajar
                      </a>
                    </div>
                  </div>
