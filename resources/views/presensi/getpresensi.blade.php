...
<tr>
    ...
    <td>
        ...
        @endphp
        <small class="text-muted color-red"><p style="color:red;">Terlambat {{$jamterlambat}}</p></small>
        @else
        <small class="text-muted"><p style="color:green;">Tepat waktu</p></small>
        @endif
    </td>
    <td><img src="{{url($foto_in)}}" alt="" class="avatar"></td>
