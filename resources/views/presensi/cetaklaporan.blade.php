    ...
    @foreach($presensi as $d)
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <img src="{{url($pathin)}}" width="120px" height="150" alt="" class="foto">
                </td>
                <td style="text-align: center;">{{$d->jam_out!=null?$d->jam_out:'Belum Absen'}}</td>
                <td style="text-align: center;">
                    @if($d->jam_out!=null)
                    <img src="{{url($pathout)}}" width="120px" height="150" alt="" class="foto">
                    @else
                    <img src="{{asset('assets/img/no_photo.jpg')}}" width="120px" height="150" alt="" class="foto">
                    @endif
                </td>
                <td style="text-align: center;">
                    @if($d->jam_in>'07:00')
